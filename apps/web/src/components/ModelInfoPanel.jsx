...
const ModelInfoPanel = ({ selectedModelId }) => {
  ...
  return (
    <div className="bg-[#FFFDF0] border-4 border-black rounded-[8px] p-5 md:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] w-full text-black">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="border-2 border-black bg-white p-3 rounded-md shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
          <div className="text-xs font-black uppercase text-black/60 tracking-widest mb-1 flex items-center gap-1"><Layers size={14}/> Context Window</div>
          <div className="font-black text-lg text-black">{model.contextWindow}</div>
        </div>
        <div className="border-2 border-black bg-white p-3 rounded-md shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
          <div className="text-xs font-black uppercase text-black/60 tracking-widest mb-1 flex items-center gap-1"><Clock size={14}/> Data Cutoff</div>
          <div className="font-black text-lg text-black">{model.trainingDataCutoff}</div>
        </div>
        <div className="border-2 border-black bg-white p-3 rounded-md shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
          <div className="text-xs font-black uppercase text-black/60 tracking-widest mb-1 flex items-center gap-1"><Coins size={14}/> Input (Per 1K)</div>
          <div className="font-black text-lg text-black">${model.inputTokenPrice}</div>
        </div>
        <div className="border-2 border-black bg-white p-3 rounded-md shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
          <div className="text-xs font-black uppercase text-black/60 tracking-widest mb-1 flex items-center gap-1"><Coins size={14}/> Output (Per 1K)</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h3 className="text-sm font-black uppercase tracking-widest mb-3 border-b-2 border-black pb-1 text-black">Performance Specs</h3>
        ...
        <div>
           <h3 className="text-sm font-black uppercase tracking-widest mb-3 border-b-2 border-black pb-1 text-black">Capabilities</h3>
           <div className="flex flex-wrap gap-2">
             {model.capabilities.map((cap, i) => (
               <span key={i} className="inline-flex items-center gap-1 bg-white text-black border-2 border-black px-2 py-1 rounded text-xs font-bold shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
