...
function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-140px)] md:min-h-[calc(100vh-155px)] bg-transparent flex items-center justify-center p-3 xs:p-4 sm:p-6 md:p-8 lg:p-12 w-full overflow-hidden font-rounded">
      <Helmet>
      ...
      <FadeIn direction="up" distance={30} delay={0.1} className="w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-[460px] z-10">
        <Card className="bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md overflow-hidden text-white shadow-2xl p-4 xs:p-5 sm:p-7 md:p-8 w-full">
          <CardHeader className="flex flex-col items-center pb-6 select-none">
            {/* Status strip matching calculator style */}
            <div className="inline-flex items-center gap-2 bg-[#E73A5A]/10 px-3 py-1 xs:px-4 xs:py-1.5 rounded-full border border-[#E73A5A]/20 text-[10px] xs:text-xs font-bold mb-4">
              <span className="bg-[#E73A5A] px-1.5 py-0.5 xs:px-2 rounded-full text-[8px] xs:text-[9px] text-white font-black">SECURE</span>
              <span className="text-gray-300 text-[9px] xs:text-[10px] sm:text-xs">OdysseusAI Orchestrator Portal</span>
            </div>
            ...
            <motion.h1 
              ...
              className="text-xl xs:text-2xl sm:text-3xl md:text-4xl font-black text-white mb-2 leading-tight text-center"
            >
              System{' '}
              <span className="text-[#E73A5A] bg-[#E73A5A]/10 px-3 py-0.5 xs:px-4 xs:py-1 border border-[#E73A5A]/20 rounded-3xl inline-block transform -rotate-1 shadow-[0_0_15px_rgba(231, 58, 90, 0.2)]">
          ...
          <CardBody className="flex flex-col gap-6 p-0">
            ...
            >
              <Tab key="login" title={
                <>
                  <span className="sm:inline hidden">Access System</span>
                  <span className="sm:hidden">Sign In</span>
                </>
              } />
              <Tab key="signup" title={
                <>
                  <span className="sm:inline hidden">Register Operator</span>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              <Button 
                ...
                className="border-white/10 hover:border-[#E73A5A] hover:bg-[#E73A5A]/10 text-white rounded-2xl h-11 xs:h-12 flex items-center justify-center gap-2"
              ...
              >
                ...
                <span className="text-[10px] xs:text-xs font-bold uppercase tracking-wider">Google</span>
              </Button>
              <Button 
                variant="bordered"
              ...
              >
                ...
                <span className="text-[10px] xs:text-xs font-bold uppercase tracking-wider">GitHub</span>
              </Button>
              <Button 
                variant="bordered"
              ...
              >
                ...
                <span className="text-[10px] xs:text-xs font-bold uppercase tracking-wider">Apple</span>
              </Button>
              <Button 
                variant="bordered"
              ...
              >
                ...
                <span className="text-[10px] xs:text-xs font-bold uppercase tracking-wider">Microsoft</span>
              </Button>
            </div>

            <div className="relative flex items-center py-1">
              <div className="flex-grow border-t border-white/10"></div>
              <span className="flex-shrink-0 mx-4 text-[10px] xs:text-xs uppercase tracking-wider text-gray-500 font-bold">Or Manual Entry</span>
              <div className="flex-grow border-t border-white/10"></div>
            </div>
