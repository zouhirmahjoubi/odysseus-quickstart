...
migrate((app) => {
  const collection = new Collection({
    ...
    "fields":     [
          ...
          },
          {
                "hidden": false,
                "id": "number7188276018",
                "name": "agent_installations_quota",
                "presentable": false,
                "primaryKey": false,
                "required": false,
                "system": false,
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_6919985718");
