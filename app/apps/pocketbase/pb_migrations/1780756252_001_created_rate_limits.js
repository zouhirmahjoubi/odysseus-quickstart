...
migrate((app) => {
  const collection = new Collection({
    ...
    "fields":     [
          ...
          },
          {
                "hidden": false,
                "id": "number1236020205",
                "name": "agent_installations_per_day",
                "presentable": false,
                "primaryKey": false,
                "required": false,
                "system": false,
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_1545301971");
